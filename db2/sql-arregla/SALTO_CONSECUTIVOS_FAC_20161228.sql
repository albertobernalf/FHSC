...
2401805, 2401806, 2401807, 2401808, 2401809, 2401810


-- Proceso :

select MAEstF,* from maeate where mpnfac  IN (2401805, 2401806, 2401807, 2401808, 2401809, 2401810) order by mpnfac
...
SELECT empcod ,  doccod ,  2401810     ,  mcdpto ,  'Salto de consecutivo' ,  agccdg ,  tranapl ,  mvcfch ,
  ...
  FROM MOVCONT3
WHERE DOCCOD='FAC' AND MVCNRO=2401811
-- COMMIT;
-- ROLLBACK;
...
select * from movcont2 WHERE DOCCOD='FAC' AND MVCNRO=2401807
select * from movcont3 WHERE DOCCOD='FAC' AND MVCNRO=2401807 
select * from hojobl where hojnumobl = '2401807'

BEGIN TRANSACTION;
INSERT INTO MOVCONT2
SELECT empcod ,  doccod ,  2401810     ,  mcdpto ,  mvccsc ,  cntvig ,  cntcod ,  cnucod ,  cnusub ,  cnccod ,  cntsub , trccod ,  2401810     ,  '' ,
  '' ,  mvcnat ,  0 ,  mvcvlrex ,  'Salto en consecutivos' ,  mvcbse ,  0 ,  mvcimpcod ,  mvccfch ,  mvcsedorg ,  mvcmes ,  mvcanio ,  mvccmpaj ,  mvcdocrf4 ,NULL,NULL
FROM MOVCONT2
WHERE DOCCOD='FAC' AND MVCNRO=2401811  AND MVCNAT='D' AND MVCCSC=1
...
SELECT empcod ,  doccod ,  2401810     ,  mcdpto ,  mvccsc ,  cntvig ,  cntcod ,  cnucod ,  cnusub ,  cnccod ,  cntsub , trccod ,  2401810     ,  '' ,
  '' ,  mvcnat ,  0 ,  mvcvlrex ,  'Salto en consecutivos' ,  mvcbse ,  0 ,  mvcimpcod ,  mvccfch ,  mvcsedorg ,  mvcmes ,  mvcanio ,  mvccmpaj ,  mvcdocrf4 ,NULL,NULL
FROM MOVCONT2
WHERE DOCCOD='FAC' AND MVCNRO=2401811  AND MVCNAT='C' AND MVCCSC=3
-- COMMIT;
-- ROLLBACK
...
BEGIN TRANSACTION;
INSERT INTO HOJOBL
SELECT empcod ,  '2401810' ,  clicod ,  cntvig ,  cntcod ,  mcdpto ,  doccod ,  mennit , cnucod , cnusub ,  hojfchobl ,  0 ,  0 ,  0 ,
  ...
  FROM HOJOBL WHERE HOJNUMOBL='2401811' AND CNTVIG=2016 AND HOJESTHOM='N'
