...
select MAEstF,* from maeate where mpnfac  = 2395798 order by mpnfac
...
SELECT empcod ,  doccod ,  2395798     ,  mcdpto ,  mvccsc ,  cntvig ,  cntcod ,  cnucod ,  cnusub ,  cnccod ,  cntsub , trccod ,  2395798     ,  '' ,
  '' ,  mvcnat ,  0 ,  mvcvlrex ,  'Salto en consecutivos' ,  mvcbse ,  0 ,  mvcimpcod ,  mvccfch ,  mvcsedorg ,  mvcmes ,  mvcanio ,  mvccmpaj ,  mvcdocrf4 ,NULL,NULL
FROM MOVCONT2
WHERE DOCCOD='FAC' AND MVCNRO=2395799  AND MVCNAT='D' AND MVCCSC=1
...
SELECT empcod ,  doccod ,  2395798     ,  mcdpto ,  mvccsc ,  cntvig ,  cntcod ,  cnucod ,  cnusub ,  cnccod ,  cntsub , trccod ,  2395798     ,  '' ,
  '' ,  mvcnat ,  0 ,  mvcvlrex ,  'Salto en consecutivos' ,  mvcbse ,  0 ,  mvcimpcod ,  mvccfch ,  mvcsedorg ,  mvcmes ,  mvcanio ,  mvccmpaj ,  mvcdocrf4 ,NULL,NULL
FROM MOVCONT2
WHERE DOCCOD='FAC' AND MVCNRO=2395799  AND MVCNAT='C' AND MVCCSC=2
-- COMMIT;
-- ROLLBACK
...
BEGIN TRANSACTION;
INSERT INTO HOJOBL
SELECT empcod ,  '2395798' ,  clicod ,  cntvig ,  cntcod ,  mcdpto ,  doccod ,  mennit , cnucod , cnusub ,  hojfchobl ,  0 ,  0 ,  0 ,
  ...
  FROM HOJOBL WHERE HOJNUMOBL='2395799' AND CNTVIG=2016 AND HOJESTHOM='N'
