...
-- 1|110010413101|NI|860007373|2020-01-01|2020-03-31|total_registros
...
where  p.profec >= '2020-01-01' and p.profec <= '2020-03-31' and  p1.crgcod >='010101' and p1.crgcod <= '869700'  ;
...
where  i.ingfecadm >= '2020-01-01 00:00:00' and i.ingfecadm  <= '2020-03-31 23:59:59' and i.mpcodp in (1,18,20,21,35,38,39,40)
 ;
