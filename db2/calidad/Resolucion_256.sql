...
inner join hosvital.hccom1 h111 on (h111.histipdoc=i.mptdoc and h111.hisckey=i.mpcedu and h111.hctvin1 = i.ingcsc and h111.fhcindesp='TR'  and  h111.hiscltr='2')
inner join hosvital.maeemp m11 on (m11.mennit=h111.FHCCodCto)
where  i.ingfecadm >= '2020-12-02 00:00:00' and i.ingfecadm  <= '2021-06-30 23:59:59' ; -- and i.mpcodp in (1,18,20,21,35,38,39,40)
...
SELECT H.HISTIPDOC,H.HISCKEY,H.HCTVIN1,H.fhcindesp, H.hiscltr, COUNT(*)
FROM HOSVITAL.HCCOM1 H
WHERE fhcindesp='TR'  and  h111.hiscltr='2' AND
 (H.HISTIPDOC,H.HISCKEY,H.HCTVIN1) IN (SELECT MPTDOC,MPCEDU,INGCSC FROM  HOSVITAL.INGRESOS WHERE INGFECADM>='2020-06-16 00:00:00' AND INGFECADM <= '2020-06-16 23:59:59')
GROUP BY  H.HISTIPDOC,H.HISCKEY,H.HCTVIN1,H.fhcindesp, H.hiscltr
HAVING COUNT(*) > 1;
