...
-- MCA195MOCA20210930NI860007373C01.txt
...
-- 1|110010413101|NI|860007373|2021-07-01|2021-09-30|total_registros
...
where  i.citfecpa >= '2021-07-01'  and i.citfecpa <= '2021-09-30' and ((i2.citpro >='881112'  and  i2.citpro <='882841' )or  (i2.citpro >= '883101' and i2.citpro<='883910'  ))
and
...
inner join hosvital.ctrlcitas c1 on (c1.citnum= i.citnum and c1.citstscit='R')
inner join hosvital.maeemp m on (m.mennit = i.citnrocto)
where   i.citfecpa >= '2021-07-01'  and i.citfecpa <= '2021-09-30' 
...
where    p.profec >= '2021-07-01' and p.profec <= '2021-09-30' and  p1.crgcod >='010101' and p1.crgcod <= '869700' and p.proesta in ('4','5')   and p1.crgest='S' 
...
inner join hosvital.maeemp m11 on (m11.mennit=p.proeps)
inner join hosvital.maedmb1 m1  on (m1.mdcodd=c.mdcodd and m1.mdcodm=c.mdcodm)
where p.profec >= '2021-07-01' and p.profec <= '2021-09-30' and  p1.crgcod >='010101' and p1.crgcod <= '869700' and p.proesta in ('3')  
order by p.procircod;
...
where  i.ingfecadm >= '2021-07-01 00:00:00' and i.ingfecadm  <= '2021-09-30 23:59:59'  and i.mpcodp in (1,18,20,21,35,38,39,40);
