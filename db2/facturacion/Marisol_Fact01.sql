...
where  ing.ingfecadm >='2021-05-01 00:00:00'  and ing.ingfecadm <= '2021-05-25 12:59:59' 
union
...
select mpcedu    from hosvital.ingresos  where ingfecadm >='2021-05-23 00:00:00' and ingfecadm <= '2021-05-23 12:59:59'  and  mpcedu >'3107443' order by mpcedu;

select * from hosvital.tmpfac1;

select * from hosvital.maeate;
select  * from hosvital.ingresos where ingfecadm >='2021-05-23 00:00:00' order by mpcedu;
/*
41369434       	
41518861       	
41519041       	
...
select * from hosvital.maeate 
where facfch>= '2020-05-23' and mpcedu >= '41349823' order by mpcedu;
/* fact
658089	
636514	
637156	
...
where  ing.ingfecadm >='2021-05-23 00:00:00' and ing.ingfecadm <= '2021-05-23 23:59:59';

-- Query Acostados Suministos

select * from hosvital.tmpfac2;

select tmp2.tfcscs, ing.ingcsc as consc_ingreso, ing.ingfecadm as Fec_ingreso, ing.IngFecEgr as Fec_egreso, Bod.boddesc  Bodega, date('1001-01-01' ) as Fec_fra, 0  as nro_Fractura, ' ' Estado_Factura, emp1.empdsc as Empresa, (select MENOMB from  hosvital.maeemp emp where  emp.mennit=ing.ingnit) as Contrato, ca.mpnomc as nom_paciente, tmp.tfcedu as Id_Paciente, ca.mpsexo as sexo, ca.MPFchN as Fec_Nacimiento, tmp2.Tffcsu as fec_servicio, tmp2.tfreso as Cod_Sum,  maesum1.msnomg as Desc_Suministro,  Tmp2.TFCans as Cant_Suministro, tmp2.tfvalu as Valor_Unitario, tmp2.Tfvats as Total_Suministros, ' ' Fec_Radicacion, ing.ingentdx as Cod_Dx_Ing, (select dmnomb from HOSVITAL.MAEDIA dia  where dia.DMCODI=ing.INGENTDX) as diagnostico_ingreso, ing.IngSalDx as Cod_Dx_Salida, (select dmnomb from hosvital.maedia dia  where dia.dmcodi=ing.IngSalDx) as Dx_Salida
from hosvital.tmpfac Tmp
inner join hosvital.ingresos Ing on (ing.mptdoc =tmp.tftdoc and Ing.mpcedu = tmp.tfcedu and ing.ingcsc = tmp.tmctving)
...
inner join hosvital.bodegas Bod on (Bod.bodega = tmp2.bodega)
inner join hosvital.maesum1 maesum1 on (maesum1.msreso=tmp2.tfreso)
where  ing.ingfecadm >='2021-05-01 00:00:00' and ing.ingfecadm <= '2021-05-23 12:59:59'
ORDER BY  12,15; 
