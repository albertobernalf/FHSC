...
select * from hosvital.movban where docCod='RC' AND  mvbnrocmp=1273;  -- MVBFCH
select * from hosvital.movban1 where docCod='RC' AND  mvbnrocmp=1273;
...
select '02',DOCCOD,MCDPTO,MVBNROCMP,MVBCSC,1,TRCCOD,'','S',MVBVLR,MVBVLR,MVBFCH  ,'',0
from hosvital.movban 
where empcod= '02' and   mcdpto='002' and doccod= 'RC'  AND  mvbnrocmp   >= 1777  and   mvbnrocmp  <= 1815  ;
