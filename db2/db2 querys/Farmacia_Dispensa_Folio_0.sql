...
SELECT * FROM hosvital.maesum1 where msnomg like ('%NUTRICION%COMP%');

-- 0015A11A       	
-- 0016A11A     
  	
 select * from hosvital.FrmSmns where hisckey='20285130'  and year(FSMFHRREG)= 2019  and month(FSMFHRREG)>=4  and fsmmsreso = '0008A11A'   ORDER BY  FSMFHRREG; 

DELETE from hosvital.FrmSmns where hisckey='20285130' and  FSMFHRREG='2019-06-02 11:47:50' AND  fsmmsreso = '0008A11A';	
