-- DOCUMENTA . Se añade validacion a los Facturacod No esten acostados aun o mejor con cargos o cuentas Abierta, el tema de Corte de Facturacion
                                Se valida en Apoyos Complementadrios que la orden No sea Ambulatoria  ni despachos ambulatorios
                                Se registra la maxima fecha de cama en la ingresomp, a veces hay 2
	   Se añade columnas aplicacion medicamentos por turnos
