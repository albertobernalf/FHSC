...
select hisckey, hiscsec,msreso,dsmfhrmov, time(dsmfhrmov) from hosvital.dspfrmc1 where  ( time(dsmfhrmov) between '18:00:01' and '23:59:59' or   time(dsmfhrmov) between '00:00:01' and '05:59:59') ;
