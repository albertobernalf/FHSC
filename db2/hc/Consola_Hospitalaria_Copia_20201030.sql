...
select 
((SELECT count(*) FROM hosvital.hccom51  H511 where H511.hisckey=H51.HISCKEY AND H511. HCTVIN51 = H51.HCTVIN51 and H511.hcfchrord >= '2020-10-26 21:03:09.0000' and H511.hcprcest IN ('I','A'))) APLICADOS, -
(SELECT count(*)  FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E'))
 pendientes,
CASE 
WHEN (((SELECT count(*) FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E'))) = 0
AND
((SELECT count(*) FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('I','A'))) = 0

) THEN 'Amarillo' 
WHEN (((SELECT count(*) FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E'))) > 0) THEN 'Rojo' 
WHEN (((SELECT count(*) FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E'))) = 0 AND

 (  (((SELECT count(*) FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('I','A')))  - 
 (SELECT count(*)  FROM hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E')))) >0 ) THEN 'Verde'
 END
from hosvital.hccom51 H51
 where H51.hisckey='11303066' and  H51.HCTVIN51 = 2 AND H51.hcfchrord >= '2020-10-26 21:03:09.0000' and H51.hcprcest IN ('O','E','I','A');



select case   when ifnull(count(*),0) = 0 then 'Amarillo'  when count(*) =0  then 'Verde'   when count(*) =0  then 'Verde'  when count(*) > 0  then 'Rojo'  end from hosvital.hccom51 where hisckey='11303066' and hcfchrord >= '2020-10-26 21:03:09.0000' and hcprcest IN ('O','E')  AND HCTVIN51=2;
...
inner join hosvital.dspfrmc1 dsp1 on (dsp1.histipdoc= f.histipdoc and dsp1.hisckey = f.hisckey and dsp1.hiscsec=f.hiscsec and dsp1.msreso=f.fsmmsreso)
where f.histipdoc= i.mptdoc and f.hisckey = i.mpcedu and f.hictvin = i.ingcsc and  f1.hcsumest in ('A') and dsp1.DSMFHRMOV >= i2.ingfecmop and  f1.hcsumcns = (select max(f11.hcsumcns) from hosvital.frmsmns1 f11 where f11.histipdoc= f.histipdoc and f11.hisckey = f.hisckey and f11.hiscsec=f.hiscsec and f11.mscodi=f.mscodi and f11.msprac=f.msprac and f11.msform=f.msform and f11.cnccd=f.cnccd and f11.hcsumest in ('A') )  )
) > 0 THEN 'Rojo Pendiente_x_Aplicar'
...
END
) Enfermeria_Aplica_Med_indicador,
